...
import { Home, FileUp, Bell, User } from 'lucide-react';
import { cn } from '@/lib/utils';

const navItems = [
  { href: '/', icon: Home, label: 'Home' },
  { href: '/pengajuan', icon: FileUp, label: 'Pengajuan' },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-full sm:max-w-md bg-background/95 backdrop-blur-sm border-t border-border z-50">
